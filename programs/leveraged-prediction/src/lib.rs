...
pub(crate) use instructions::delegate_price_account::__client_accounts_delegate_price_account;
...
pub(crate) use instructions::initialize_market_with_price_account::__client_accounts_initialize_market_with_price_account;
pub(crate) use instructions::initialize_price_account::__client_accounts_initialize_price_account;
...
pub(crate) use instructions::update_price::__client_accounts_update_price;
pub(crate) use instructions::withdraw_protocol_fees::__client_accounts_withdraw_protocol_fees;

declare_id!("CPUwSRL2h3mh27GutZ3k6hcHt4swrV1NcQAUuLQUbQYX");
...
pub const MAX_PRICE_AGE_SECONDS: i64 = 5;
pub const PRICE_SCALE: u64 = 1_000_000;
pub const DEFAULT_PAYOUT_BPS: u16 = 19_000;
pub const DEFAULT_MAX_OPEN_EXPOSURE: u64 = 10_000_000_000;
...
pub mod leveraged_prediction {
    ...
    pub fn initialize_price_account(
        ctx: Context<InitializePriceAccount>,
        asset_symbol: [u8; 16],
        dex: [u8; 8],
    ) -> Result<()> {
        instructions::initialize_price_account::handler(ctx, asset_symbol, dex)
    }
    ...
    pub fn delegate_price_account(
        ctx: Context<DelegatePriceAccount>,
        asset_symbol: [u8; 16],
        validator: Pubkey,
    ) -> Result<()> {
        instructions::delegate_price_account::handler(ctx, asset_symbol, validator)
    }

    pub fn initialize_market_with_price_account(
        ...
        instructions::initialize_market_with_price_account::handler(
            ctx,
            market_id,
            sponsor_lamports,
            payout_bps,

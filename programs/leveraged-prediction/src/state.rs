...
pub struct Market {
    ...
    pub mode: MarketMode,
    pub bump: u8,
    // Hyperliquid bridge (devnet): price_account is the canonical feed; oracle fields are legacy Pyth.
...
mod tests {
    ...
    fn account_storage_budget_is_locked() {
        ...
        assert_eq!(PriceAccount::INIT_SPACE, 73);
        assert_eq!(Market::INIT_SPACE, 150);
        ...
        assert_eq!(8 + PriceAccount::INIT_SPACE, 81);
        assert_eq!(8 + Market::INIT_SPACE, 158);
    ...
    fn market_fixture(market_id: u16, oracle: Pubkey, oracle_feed_id: [u8; 32]) -> Market {
        Market {
            ...
            payout_bps: crate::DEFAULT_PAYOUT_BPS,
            max_open_exposure: crate::DEFAULT_MAX_OPEN_EXPOSURE,
        }
    }

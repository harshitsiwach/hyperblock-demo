    ...
    <div style={{ position: "relative" }}>
      <div className="relative inline-flex items-center justify-center rounded-xl transition-transform duration-200 hover:scale-105">
        ...
        <button
          ...
          className="relative z-10 flex items-center gap-1.5 rounded-xl border border-[var(--color-neon-orange)]/35 bg-[var(--card)] px-3 py-1 text-xs font-bold text-[var(--ink)] hover:bg-[var(--hair)] transition-all focus:outline-none"
          style={{

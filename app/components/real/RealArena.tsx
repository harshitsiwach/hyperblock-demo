...
export function RealArena() {
  ...
  return (
    <div className="min-h-screen terminal-grid-bg text-[var(--ink)] flex flex-col font-sans selection:bg-[var(--ui-tint-bg)] selection:text-[var(--ink)] relative transition-colors duration-200">
      ...
      <TerminalNav
        ...
        snapshot={undefined}
        isReal={true}
        level={Math.max(1, 1 + Math.floor(realTrade.historyPlays.length / 3))}
      />
      ...
      <main className="mx-auto flex-1 w-full max-w-[1720px] px-3 sm:px-4 lg:px-6 pt-3 sm:pt-4 space-y-4 lg:space-y-5 pb-20 lg:pb-8">
        ...
        <div className="grid grid-cols-1 gap-4 lg:grid-cols-12 lg:gap-5">
          ...
          <div className="lg:col-span-3 flex flex-col gap-3.5 h-full">
            {needsApproval && (
              <div className="rounded-xl border border-[var(--ui-tint-border)] bg-[var(--ui-tint-bg)] backdrop-blur-md px-3.5 py-3 text-[11px] text-[var(--ink)]">
                ...
                <button
                  ...
                  className="mt-2 w-full rounded-lg bg-[var(--ui-tint-color)] px-3 py-1.5 text-[11px] font-bold text-black disabled:opacity-50 transition-all hover:brightness-110 active:scale-[0.98]"
                >
            ...
            {settling && (
              <div className="rounded-xl border border-emerald-500/30 bg-emerald-500/[0.08] backdrop-blur-md px-3.5 py-2.5 text-[11px] font-bold text-emerald-400 animate-pulse">

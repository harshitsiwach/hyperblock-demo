    ...
    <div className="terminal-card flex flex-col justify-between gap-2.5 p-3.5 flex-1 h-full">
      ...
      <div className="flex items-center justify-between border-b border-[var(--hair)] pb-2">
        <div className="flex items-center gap-2.5">
          <div className="relative flex h-8 w-8 items-center justify-center rounded-lg bg-[var(--card)] border border-[var(--hair)] shadow-sm">
          ...
          <div className="rounded-lg border border-[var(--hair)] bg-[var(--panel)] px-2.5 py-1.5 space-y-1">
            ...
            <div className="relative h-1.5 w-full rounded-full bg-slate-200 dark:bg-[var(--card)] overflow-visible">
              ...
              <div
                ...
                style={{ left: `${rangePct}%` }}
              >
                <span className="h-3 w-1.5 rounded-full bg-[var(--ink)] shadow-md border border-[var(--hair)] block" />
              </div>
            </div>
          </div>
        );
      ...
      <div className="rounded-lg border border-[var(--hair)] bg-[var(--card)] p-2 space-y-1">
        ...
        <div className="relative flex h-2 w-full overflow-hidden rounded-full bg-[var(--card)] border border-[var(--hair)]">
          <div

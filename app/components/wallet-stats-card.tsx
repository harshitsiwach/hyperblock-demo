    ...
    return (
      <div
        style={{
          ...
          borderRadius: variant === "popover" ? 14 : 16,
          background: variant === "popover" ? "var(--card)" : "linear-gradient(135deg, var(--card), var(--bg))",
      ...
      >
        ...
        <button onClick={() => void wallet.connect()} style={{ marginTop: 12, width: "100%", minHeight: 38, borderRadius: 10, background: "var(--ink)", color: "var(--bg)", fontWeight: 800, fontSize: 13 }}>
          Connect wallet
        </button>
      </div>
    );
  ...
  return (
    <div
      style={{
        ...
        borderRadius: variant === "popover" ? 16 : 16,
    ...
    >
      {/* header */}
      <div style={{ padding: variant === "popover" ? "14px 14px 12px" : "16px 16px 12px", display: "flex", gap: 12, alignItems: "center", borderBottom: "1px solid var(--hair)", background: "linear-gradient(135deg, var(--card), color-mix(in srgb, var(--ink) 4%, var(--card)))" }}>
        <div style={{ width: 36, height: 36, borderRadius: 10, background: "var(--ink)", color: "var(--bg)", display: "grid", placeItems: "center", fontWeight: 800, fontSize: 14 }}>{wallet.address.slice(0, 2).toUpperCase()}</div>
      ...
      <div style={{ padding: variant === "popover" ? 12 : 16 }}>
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 10 }}>
          <div style={{ padding: "12px 12px", borderRadius: 12, background: "var(--bg)", border: "1px solid var(--hair)" }}>
          ...
          <div style={{ padding: "12px 12px", borderRadius: 12, background: "linear-gradient(135deg, var(--card), var(--up-tint))", border: "1px solid color-mix(in srgb, var(--up) 18%, var(--hair))" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 10, marginTop: 10 }}>
          <div style={{ padding: "10px 12px", borderRadius: 12, background: "var(--card)", border: "1px solid var(--hair)" }}>
          ...
          <div style={{ padding: "10px 12px", borderRadius: 12, background: "var(--wait-tint)", border: "1px solid var(--hair)" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 8, marginTop: 10 }}>
          <div style={{ padding: "10px 10px", borderRadius: 12, background: "var(--bg)", border: "1px solid var(--hair)", textAlign: "center" }}>
          ...
          <div style={{ padding: "10px 10px", borderRadius: 12, background: "var(--up-tint)", border: "1px solid var(--hair)", textAlign: "center" }}>
          ...
          <div style={{ padding: "10px 10px", borderRadius: 12, background: "var(--down-tint)", border: "1px solid var(--hair)", textAlign: "center" }}>
        ...
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginTop: 10, padding: "10px 12px", borderRadius: 12, background: totalProfit >= 0 ? "var(--up-tint)" : "var(--down-tint)", border: `1px solid ${totalProfit >= 0 ? "var(--up)" : "var(--down)"}` }}>
        ...
        {balances.error && <div style={{ marginTop: 8, fontSize: 11, color: "var(--down)", background: "var(--down-tint)", padding: "8px 10px", borderRadius: 10 }}>{balances.error}</div>}
